...
struct Cli {
	...
	/// Cammera follows target (--follow) by this distance (km).
...
fn main() -> Result<()> {
	...
	println!("[I] camera follows body {} ({}) from {} km", body_propts[args.follow].col, &body_propts[args.follow].name, args.follow_km);
